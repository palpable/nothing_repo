...
ActiveRecord::Schema.define(:version => 20110509135505) do
  ...
  create_table "cb_forums", :force => true do |t|
    t.string   "name"
    t.text     "description"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "cb_topics_count", :default => 0, :null => false
  end

  create_table "cb_posts", :force => true do |t|
    t.integer  "blog_id"
  ...
  add_index "cb_posts", ["blog_id"], :name => "index_cb_posts_on_blog_id"
  add_index "cb_posts", ["cb_topic_id"], :name => "index_cb_posts_on_cb_topic_id"
  add_index "cb_posts", ["type"], :name => "index_cb_posts_on_type"

  create_table "cb_topics", :force => true do |t|
    t.integer  "cb_forum_id"
    t.integer  "person_id"
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "cb_posts_count", :default => 0, :null => false
  end

  add_index "cb_topics", ["cb_forum_id"], :name => "index_cb_topics_on_cb_forum_id"

  create_table "centralbank_lists", :force => true do |t|
  ...
  create_table "check_links", :force => true do |t|
    t.string   "name"
    t.string   "icon"
    t.string   "link"
    t.datetime "created_at"
  ...
  create_table "docattachments", :force => true do |t|
    t.integer  "size"
    t.integer  "height"
    t.integer  "width"
    t.integer  "parent_id"
  ...
  add_index "docattachments", ["attachable_id", "attachable_type"], :name => "index_docattachments_on_attachable_id_and_attachable_type"
  add_index "docattachments", ["parent_id"], :name => "index_docattachments_on_parent_id"
  ...
  create_table "flvu_u_urls", :force => true do |t|
    t.string   "addr"
    t.integer  "person_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "road_show_id"
    t.integer  "room_id"
  end
  ...
  create_table "news_feeds", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "set_default", :default => false
  end
  ...
  create_table "people", :force => true do |t|
    ...
    t.boolean  "phone_visibility",           :default => true
    t.boolean  "email_visibility",           :default => true
  ...
  create_table "sovereign_wealth_funds", :force => true do |t|
    t.string   "country_name"
    t.string   "fund_name"
    t.string   "url_name"
    t.string   "assest"
  ...
  create_table "youtube_u_links", :force => true do |t|
    t.string   "title"
    t.text     "addr"
    t.string   "uniqueid"
    t.string   "total_time"
